...
public class Store {
	...
	private String storeStartT;
	private String storeEndT;
	...
	public Store(int storeNo, String storeCeo, String storeAddr, String storeTel, String storeDet, String storeName,
			int storeCateId, String storeStartT, String storeEndT, String storeFilepath, String storeFilename,
			String storeRest) {
		super();
		...
		this.storeStartT = storeStartT;
		this.storeEndT = storeEndT;
	...
	public String getStoreStartT() {
		return storeStartT;
	}
	public void setStoreStartT(String storeStartT) {
		this.storeStartT = storeStartT;
	}
	public String getStoreEndT() {
		return storeEndT;
	}
	public void setStoreEndT(String storeEndT) {
		this.storeEndT = storeEndT;
	}
