...
<body>
	<div class="content-all-wrap">
        ...
        <form action="/join" method="post">
            <table class="join-table">
                ...
                <tr>
                    <td colspan="3"><input type="text" name="cliId" id="cliId" class="join-input"></td>
                    <td style="width: 10px;">
                        <p class="p-checkId">
                            
                           <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-check-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg" color="green" id="ok">
  <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
  <path fill-rule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/>
</svg>

                            <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-x-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg" color="red" id="no">
  <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                    ...
                    <!--                    <td style="text-align: right;"><button type="button" onclick="checkId();">중복체크</button></td>-->
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"><input type="text" name="cliEmail" id="cliEmail" class="join-input"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><button>우편번호 찾기</button></td>
                </tr>
                <tr>
                    <th colspan="3">주소<span></span></th>
                </tr>
                <tr>
                    <td colspan="3"><input type="text" name="cliAddr" id="cliAddr" class="join-input"></td>
                </tr>
                <tr>
                    <th colspan="3">상세주소<span></span></th>
                </tr>
                <tr>
                    <td colspan="3"><input type="text" name="cliAddrDet" id="cliAddrDet" class="join-input"></td>
                </tr>
                <tr>
                    <th colspan="3">이름<span></span></th>
                </tr>
                <tr>
                    <td colspan="3"><input type="text" name="cliName" id="cliName" class="join-input"></td>
                </tr>
                <tr>
                    <th colspan="3">전화번호<span></span></th>
                </tr>
                <tr>
                    <td colspan="3"><input type="text" name="cliTel" id="cliTel" class="join-input"></td>
                </tr>
                <tr>
                    <th colspan="3">닉네임<span></span></th>
                </tr>
                <tr>
                    <td colspan="3"><input type="text" name="cliNick" id="cliNick" class="join-input"></td>
                </tr>
                <!--                추가정보-->
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <input type="radio" name="cliGender" id="m" value="m" class="join-input"><label for="m" class="radio-label">남자</label>
                        <input type="radio" name="cliGender" id="f" value="f" class="join-input"><label for="f" class="radio-label">여자</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <input type="date" name="cliBirth" id="cliBirth" class="join-input" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="check-td" style="height: 300px;">
                        <input type="checkbox" id="all"><label for="all">&nbsp;전체 약관에 동의합니다.</label>

                        <br>
                        <input type="checkbox" id="check1"><label for="check1">&nbsp;필수 항목에 동의합니다.</label><br>
                        <a href="#">이용약관</a>
                        <a href="#">개인정보 수집이용 동의</a>
                        <br>
                        <input type="checkbox" id="check2"><label for="check2">&nbsp;광고성 정보 수신 동의(선택)</label><br>
                        <a href="#">회원에게 제공하는 서비스의 광고성 정보를 수신합니다.</a>
                        <br>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        ...
                        <button type="submit" style="width: 350px; height: 70px; font-size: 1.5em;" id="joinBtn">회원가입</button>
                    </td>
                </tr>
            </table>
        </form>
